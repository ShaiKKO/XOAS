...
| [`../adr/IDR-0002-target0-qualification-tool-deployment.md`](../adr/IDR-0002-target0-qualification-tool-deployment.md) | Accepted; initial path passed at `a312aa2`; current replacement cross-host verification passed at `a396f64` | Separate `gpu-2` quality and physical native-build authority, closed dual-build evidence bundle, replica verification, and no campaign authority |
| [`../adr/IDR-0003-target0-qualification-campaign-runner.md`](../adr/IDR-0003-target0-qualification-campaign-runner.md) | Accepted; implementation at `db0eb87`; attempt 1 retained as `restoration_failure`; attempt 2 retained as PMU `process_schema_failure`; parent-traversal repair at `0a30b24` awaits complete quality and integration | Closed two-phase qualification campaign, exact identity/statistical evidence, and dedicated privileged-PMU boundary |
...
| [`../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md`](../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md) | Tasks 1–9 complete; Task 10 attempts 1 and 2 are terminal retained rejections; source repair invalidates attempt 2's bundle/preflight for future execution | Closed campaign contract, dedicated privileged-PMU boundary, exact-commit verification, campaign one, and stop-before-reboot handoff |
| [`../superpowers/plans/2026-08-30-target0-pmu-traversal-repair.md`](../superpowers/plans/2026-08-30-target0-pmu-traversal-repair.md) | Tasks 1–2 implemented through red `cc826f2` and repair `0a30b24`; terminal evidence and complete quality/integration remain in progress | Preserve attempt 2 rejection, repair only the nested PMU traversal boundary, and stop before any replacement live attempt |
...
| [`../../benchmarks/evidence/target0-amd-ryzen9-7900x-v1/qualification-tools-v1.json`](../../benchmarks/evidence/target0-amd-ryzen9-7900x-v1/qualification-tools-v1.json) | Accepted non-claiming replacement deployment receipt at `a396f64`; physical and `gpu-2` bundles retained externally | Canonical source/toolchain/build/runtime evidence plus companion inventory, executable, boot, and replica digests |
