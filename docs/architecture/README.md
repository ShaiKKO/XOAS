...
| [`../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md`](../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md) | Tasks 1–7 complete through exact quality subject `7b486e1`; live Tasks 8–10 remain open | Closed campaign contract, dedicated privileged-PMU boundary, exact-commit verification, campaign one, and stop-before-reboot handoff |
