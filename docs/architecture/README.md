...
| [`../adr/IDR-0003-target0-qualification-campaign-runner.md`](../adr/IDR-0003-target0-qualification-campaign-runner.md) | Accepted; implementation at `db0eb87`, attempt 1 retained as `restoration_failure`, restoration plus fresh physical/`gpu-2` deployment verified at `a396f64`, and replacement read-only preflight independently accepted | Closed two-phase qualification campaign, exact identity/statistical evidence, and dedicated privileged-PMU boundary |
...
| [`../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md`](../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md) | Tasks 1–9 complete; Task 10 attempt 1 retained as `restoration_failure`; replacement Task 9 preflight at `a396f64` independently accepted; a new approved attempt remains open | Closed campaign contract, dedicated privileged-PMU boundary, exact-commit verification, campaign one, and stop-before-reboot handoff |
