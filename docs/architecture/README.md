...
| [`../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md`](../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md) | Tasks 1–9 complete; Task 10 attempt 1 retained as `restoration_failure`; repair and a new approved attempt remain open | Closed campaign contract, dedicated privileged-PMU boundary, exact-commit verification, campaign one, and stop-before-reboot handoff |
