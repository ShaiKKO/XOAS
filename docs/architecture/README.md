...
| [`../adr/IDR-0003-target0-qualification-campaign-runner.md`](../adr/IDR-0003-target0-qualification-campaign-runner.md) | Accepted; implementation at `db0eb87`, attempt 1 retained as `restoration_failure`, source repair verified through `c9af373`, and physical restoration-only proof passed at `a396f64`; the fresh physical bundle is locally verified while the required independent replica and preflight remain open | Closed two-phase qualification campaign, exact identity/statistical evidence, and dedicated privileged-PMU boundary |
...
| [`../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md`](../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md) | Tasks 1–9 complete; Task 10 attempt 1 retained as `restoration_failure`; physical restoration-only proof and the physical half of fresh deployment passed at `a396f64`; independent replica, preflight, and a new approved attempt remain open | Closed campaign contract, dedicated privileged-PMU boundary, exact-commit verification, campaign one, and stop-before-reboot handoff |
