...
| [`../adr/IDR-0003-target0-qualification-campaign-runner.md`](../adr/IDR-0003-target0-qualification-campaign-runner.md) | Accepted; implementation at `db0eb87`, attempt 1 retained as `restoration_failure`, and test-first source repair verified at `93e9070`; physical repair proof and redeployment remain open | Closed two-phase qualification campaign, exact identity/statistical evidence, and dedicated privileged-PMU boundary |
...
| [`../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md`](../superpowers/plans/2026-08-29-target0-qualification-campaign-runner.md) | Tasks 1–9 complete; Task 10 attempt 1 retained as `restoration_failure`; source repair verified at `93e9070`; fresh deployment and a new approved attempt remain open | Closed campaign contract, dedicated privileged-PMU boundary, exact-commit verification, campaign one, and stop-before-reboot handoff |
