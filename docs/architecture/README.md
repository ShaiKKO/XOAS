...
| [`../../toolchains/target0-amd-ryzen9-7900x-v1.lock.json`](../../toolchains/target0-amd-ryzen9-7900x-v1.lock.json)           | Installed and schema-valid; live 288-file identity verified against Task 4 subject `16d698d` | Full package pre-state/closure, source locks, build/test commands, validations, artifact hashes, and rollback boundary |
